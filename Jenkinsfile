pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://52.90.118.182:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/2300033437/FullstackAppForAWS.git', branch: 'master'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://52.90.118.182:9090/springapp1"
            echo "✅ Frontend deployed: http://52.90.118.182:9090/frontapp1"
        }
        failure {
